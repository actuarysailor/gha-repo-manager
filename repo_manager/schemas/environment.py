...
class DeploymentBranchPolicy(BaseModel):
    protected_branches: bool = Field(None, description="Restrict deployment to environment from protected branches only")
    custom_branch_policies: bool = Field(None, description="Restrict deployment to environment from custom branch policies only")
