...
def __run_as_installed_app__(api_url: str, app_id: int, private_key: str, owner: str | None, repo: str | None) -> tuple[Github, dict]:
...
@lru_cache
def get_github_client(api_url: str, token: str | None, app_id: int | None, private_key: str | None, owner: str | None, repo: str | None, **kwargs) -> tuple[Github, dict]:
