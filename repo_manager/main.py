...
from repo_manager.gh.org_settings import check_org_settings, update_org_settings
...
REQUIRED_PERMISSIONS = {
    ...
    "org_settings": {
        "app_permission": "members: write",
        "pat_scope": "admin:org",
        "description": "Organization-level settings (description, permissions, etc.)",
        "probe_path": None,
    },
    "teams": {
        "app_permission": "members: write",
    ...
    "org_rulesets": {
        "app_permission": "administration: write",
        "pat_scope": "admin:org",
        "description": "Organization-level branch/tag rulesets",
        "probe_path": None,
    },
    "org_secrets": {
        "app_permission": "secrets: write",
        "pat_scope": "admin:org",
        "description": "Organization-level Actions/Dependabot secrets",
        "probe_path": None,
    },
    "org_variables": {
        "app_permission": "variables: write",
...
def main():  # noqa: C901
    ...
    if inputs.get("scope") == "org" and org_object is not None:
        for check, to_check in {
            ...
            check_name, to_check_val = to_check
